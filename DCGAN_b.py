...
with tf.Session() as sess:
    ...
    for e in range(EPOCHS):
        ...
        for i in range(iteration):
            ...
            rand_multivariate = _multivariate_dist(BATCH_SIZE)
            _, D_loss_curr = sess.run([D_solver, D_loss], {X: x, z: rand_multivariate})
            rand_multivariate = _multivariate_dist(BATCH_SIZE)
            _, G_loss_curr = sess.run([G_solver, G_loss], {z: rand_multivariate})
        ...
        data = sess.run(G, {z: rand_multivariate})
